...
def register_152_178():
    ...
    for row in sheet.iter_rows(min_row=min_r, max_row=max_r, values_only=True):
        ...
        # Default Category ID to 8 (Gift Set) for consistency unless specified otherwise
        # This seems to be the pattern for these recent batches (138-178 range)
        cat_id = 8 
